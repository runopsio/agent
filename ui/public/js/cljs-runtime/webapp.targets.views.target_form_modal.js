...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__30777 = cljs.core.get_global_hierarchy;
return (fexpr__30777.cljs$core$IFn$_invoke$arity$0 ? fexpr__30777.cljs$core$IFn$_invoke$arity$0() : fexpr__30777.call(null));
})());
...
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__30779 = cljs.core.get_global_hierarchy;
return (fexpr__30779.cljs$core$IFn$_invoke$arity$0 ? fexpr__30779.cljs$core$IFn$_invoke$arity$0() : fexpr__30779.call(null));
})());
...
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__30781 = cljs.core.get_global_hierarchy;
return (fexpr__30781.cljs$core$IFn$_invoke$arity$0 ? fexpr__30781.cljs$core$IFn$_invoke$arity$0() : fexpr__30781.call(null));
})());
...
webapp.targets.views.target_form_modal.config__GT_inputs = (function webapp$targets$views$target_form_modal$config__GT_inputs(p__30784,index,config){
var map__30785 = p__30784;
var map__30785__$1 = cljs.core.__destructure_map(map__30785);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30785__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30785__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
return (function (){
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function webapp$targets$views$target_form_modal$config_inputs_for_$_iter__30786(s__30787){
return (new cljs.core.LazySeq(null,(function (){
var s__30787__$1 = s__30787;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__30787__$1);
if(temp__5753__auto__){
var s__30787__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30787__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__30787__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__30789 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__30788 = (0);
while(true){
if((i__30788 < size__4651__auto__)){
var index = cljs.core._nth(c__4650__auto__,i__30788);
cljs.core.chunk_append(b__30789,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.targets.views.target_form_modal.config__GT_inputs,cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(config),index),index,config], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(config),index)], null)));

var G__30801 = (i__30788 + (1));
i__30788 = G__30801;
continue;
} else {
return true;
...
return JSON.stringify(cljs.core.clj__GT_js(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__30790){
var map__30791 = p__30790;
var map__30791__$1 = cljs.core.__destructure_map(map__30791);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30791__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__30792){
var map__30793 = p__30792;
var map__30793__$1 = cljs.core.__destructure_map(map__30793);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30793__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30793__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__30794){
var vec__30795 = p__30794;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30795,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30795,(1),null);
...
return webapp.targets.views.target_form_modal.dispatch_form.cljs$core$IFn$_invoke$arity$2(form_type,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1843675177),cljs.core.deref(name),new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.deref(target_type),new cljs.core.Keyword(null,"tags","tags",1771418977),cljs.core.deref(tags)], null),(function (){var G__30800 = cljs.core.deref(secrets_host);
switch (G__30800) {
case "runops":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30800)].join('')));
...
})], null),webapp.targets.views.target_form_modal.section("Target information","",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.grid-cols-2.gap-regular","div.grid.grid-cols-2.gap-regular",-1979651726),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.forms.input,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"label","label",1718410804),"Name",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30798_SHARP_){
return cljs.core.reset_BANG_(name,webapp.formatters.replace_empty_space__GT_dash(p1__30798_SHARP_.target.value));
}),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Target name",new cljs.core.Keyword(null,"required","required",1807647006),true,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(form_type,new cljs.core.Keyword(null,"update","update",1045576396)),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(name)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.forms.select,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"label","label",1718410804),"Target type",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30799_SHARP_){
return change_target_type(p1__30799_SHARP_.target.value);
