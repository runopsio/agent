...
var G__41200 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__41200__$1 = (((G__41200 == null))?null:cljs.core.iterate((function (loc){
...
var G__41200__$2 = (((G__41200__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__41200__$1));
var G__41200__$3 = (((G__41200__$2 == null))?null:cljs.core.last(G__41200__$2));
if((G__41200__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__41200__$3);
}
} else {
return zloc;
}
...
var G__41219 = rewrite_clj.zip.move.right(v);
var G__41220 = rewrite_clj.zip.move.up(v);
loc = G__41219;
parent = G__41220;
continue;
} else {
var G__41222 = rewrite_clj.zip.move.right(v0);
var G__41223 = parent;
loc = G__41222;
parent = G__41223;
continue;
...
var G__41224 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__41225 = rewrite_clj.zip.move.up(v);
loc = G__41224;
parent = G__41225;
continue;
} else {
var G__41226 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__41227 = parent;
loc = G__41226;
parent = G__41227;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__41216 = zloc;
var G__41216__$1 = (((G__41216 == null))?null:rewrite_clj.zip.move.down(G__41216));
var G__41216__$2 = (((G__41216__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__41216__$1,k));
if((G__41216__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__41216__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__41217 = rewrite_clj.zip.move.down(zloc);
var G__41217__$1 = (((G__41217 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__41217));
if((G__41217__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__41217__$1);
}
})(),k);
}
});
