...
var G__31106 = devtools.prefs.pref(v);
v = G__31106;
continue;
} else {
return v;
...
}catch (e31076){var _e__25491__auto__ = e31076;
return false;
}})();
...
}catch (e31080){var _e__25491__auto__ = e31080;
return false;
}})();
...
}catch (e31082){var _e__25491__auto__ = e31082;
return false;
}}
}
});
...
var vec__31089 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31089,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31089,(1),null);
...
return cljs.core.some((function (p1__31094_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__31094_SHARP_);
}),template);
});
