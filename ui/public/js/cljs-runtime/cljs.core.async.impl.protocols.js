...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_43883 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_43883(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_43884 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_43884(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_43885 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_43885(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_43886 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_43886(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_43887 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_43887(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_43888 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_43888(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_43889 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_43889(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_43890 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_43890(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_43891 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_43891(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_43892 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_43892(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_43893 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_43893(b);
}
});
