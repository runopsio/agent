...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__30806 = cljs.core.get_global_hierarchy;
return (fexpr__30806.cljs$core$IFn$_invoke$arity$0 ? fexpr__30806.cljs$core$IFn$_invoke$arity$0() : fexpr__30806.call(null));
})());
...
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__30807 = cljs.core.get_global_hierarchy;
return (fexpr__30807.cljs$core$IFn$_invoke$arity$0 ? fexpr__30807.cljs$core$IFn$_invoke$arity$0() : fexpr__30807.call(null));
})());
...
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__30808 = cljs.core.get_global_hierarchy;
return (fexpr__30808.cljs$core$IFn$_invoke$arity$0 ? fexpr__30808.cljs$core$IFn$_invoke$arity$0() : fexpr__30808.call(null));
})());
...
webapp.targets.views.target_form.config__GT_inputs = (function webapp$targets$views$target_form$config__GT_inputs(p__30811,index,config){
var map__30812 = p__30811;
var map__30812__$1 = cljs.core.__destructure_map(map__30812);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30812__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30812__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
return (function (){
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function webapp$targets$views$target_form$config_inputs_for_$_iter__30813(s__30814){
return (new cljs.core.LazySeq(null,(function (){
var s__30814__$1 = s__30814;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__30814__$1);
if(temp__5753__auto__){
var s__30814__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30814__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__30814__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__30816 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__30815 = (0);
while(true){
if((i__30815 < size__4651__auto__)){
var index = cljs.core._nth(c__4650__auto__,i__30815);
cljs.core.chunk_append(b__30816,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.targets.views.target_form.config__GT_inputs,cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(config),index),index,config], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(config),index)], null)));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30816),webapp$targets$views$target_form$config_inputs_for_$_iter__30813(cljs.core.chunk_rest(s__30814__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30816),null);
}
} else {
var index = cljs.core.first(s__30814__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.targets.views.target_form.config__GT_inputs,cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(config),index),index,config], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(config),index)], null)),webapp$targets$views$target_form$config_inputs_for_$_iter__30813(cljs.core.rest(s__30814__$2)));
}
} else {
return null;
}
...
return JSON.stringify(cljs.core.clj__GT_js(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__30817){
var map__30818 = p__30817;
var map__30818__$1 = cljs.core.__destructure_map(map__30818);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30818__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30818__$1,new cljs.core.Keyword(null,"value","value",305978217));
return cljs.core.PersistentArrayMap.createAsIfByAssoc([key,value]);
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__30819){
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__30829){
var vec__30830 = p__30829;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30830,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30830,(1),null);
...
})], null),webapp.targets.views.target_form.section("Informations","General informations of your target",new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.grid-cols-4.gap-x-regular","div.grid.grid-cols-4.gap-x-regular",285141703),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-span-2","div.col-span-2",-228761363),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.forms.input,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"label","label",1718410804),"Name",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30835_SHARP_){
return cljs.core.reset_BANG_(name,webapp.formatters.replace_empty_space__GT_dash(p1__30835_SHARP_.target.value));
}),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Target name",new cljs.core.Keyword(null,"required","required",1807647006),true,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(form_type,new cljs.core.Keyword(null,"update","update",1045576396)),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(name)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-span-2","div.col-span-2",-228761363),webapp.components.forms.select(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"label","label",1718410804),"Target type",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30836_SHARP_){
return change_target_type(p1__30836_SHARP_.target.value);
}),new cljs.core.Keyword(null,"selected","selected",574897764),cljs.core.deref(target_type),new cljs.core.Keyword(null,"required","required",1807647006),true,new cljs.core.Keyword(null,"options","options",99638489),webapp.targets.constants.targets_types_list], null))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-span-3","div.col-span-3",1985322016),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.forms.textarea,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"label","label",1718410804),"Description",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30837_SHARP_){
return cljs.core.reset_BANG_(description,p1__30837_SHARP_.target.value);
}),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Add a description to your target",new cljs.core.Keyword(null,"rows","rows",850049680),(2),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(description)], null)], null)], null)], null)),webapp.targets.views.target_form.section("Permission management","Management who can access the target and the behavior of task's review in this target",new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.grid-cols-2.gap-x-regular.mb-regular","div.grid.grid-cols-2.gap-x-regular.mb-regular",1322497436),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-span-2.mb-regular","div.col-span-2.mb-regular",549564773),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.headings.h4,"Access control"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-span-1","div.col-span-1",1379827151),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.forms.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"label","label",1718410804),"Groups",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30838_SHARP_){
return cljs.core.reset_BANG_(groups,p1__30838_SHARP_.target.value);
}),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Comma separated string",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(groups)], null)], null)], null)], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.grid-cols-2.gap-x-regular.mb-regular","div.grid.grid-cols-2.gap-x-regular.mb-regular",1322497436),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-span-2.mb-regular","div.col-span-2.mb-regular",549564773),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.headings.h4,"Review control"], null)], null),webapp.components.forms.select(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"label","label",1718410804),"Who approves",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30839_SHARP_){
cljs.core.reset_BANG_(review_type,p1__30839_SHARP_.target.value);

cljs.core.reset_BANG_(reviewers,"");

return cljs.core.reset_BANG_(channel_name,"");
}),new cljs.core.Keyword(null,"selected","selected",574897764),cljs.core.deref(review_type),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),"none",new cljs.core.Keyword(null,"text","text",-1790561697),"none"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),"anyone",new cljs.core.Keyword(null,"text","text",-1790561697),"anyone"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),"team",new cljs.core.Keyword(null,"text","text",-1790561697),"groups"], null)], null)], null)),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(review_type),"team"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.forms.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"label","label",1718410804),"Reviewer's groups",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30840_SHARP_){
return cljs.core.reset_BANG_(reviewers,p1__30840_SHARP_.target.value);
}),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Comma separated string",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(reviewers)], null)], null):null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(review_type),"none"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.forms.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"label","label",1718410804),"Slack channel name",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30841_SHARP_){
return cljs.core.reset_BANG_(channel_name,p1__30841_SHARP_.target.value);
}),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Slack channel name",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(channel_name)], null)], null):null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.grid-cols-2.gap-x-regular","div.grid.grid-cols-2.gap-x-regular",152280020),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-span-2.mb-regular","div.col-span-2.mb-regular",549564773),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.headings.h4,"Data control"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-span-1","div.col-span-1",1379827151),webapp.components.forms.select(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"label","label",1718410804),"Redact sensitive data",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30842_SHARP_){
return cljs.core.reset_BANG_(redact,p1__30842_SHARP_.target.value);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30888__$1)].join('')));
