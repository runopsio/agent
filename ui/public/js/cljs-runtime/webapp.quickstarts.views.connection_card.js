goog.provide('webapp.quickstarts.views.connection_card');
webapp.quickstarts.views.connection_card.main = (function webapp$quickstarts$views$connection_card$main(attr,target_type,target_img,configs){
...
return cljs.core.reset_BANG_(configs,webapp.quickstarts.utilities.get_config_keys(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(value)));
})], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),text], null));
});

//# sourceMappingURL=webapp.quickstarts.views.connection_card.js.map
