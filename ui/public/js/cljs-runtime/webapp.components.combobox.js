...
webapp.components.combobox.combobox_item = (function webapp$components$combobox$combobox_item(p__49957){
var map__49959 = p__49957;
var map__49959__$1 = cljs.core.__destructure_map(map__49959);
var item = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49959__$1,new cljs.core.Keyword(null,"item","item",249373802));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49959__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49959__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var close_list = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49959__$1,new cljs.core.Keyword(null,"close-list","close-list",-1609015538));
...
var G__49960_49991 = new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(item);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__49960_49991) : on_change.call(null,G__49960_49991));
...
return clojure.string.includes_QMARK_(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__49965_SHARP_),pattern);
}),options);
});
/**
 ...
 */
webapp.components.combobox.main = (function webapp$components$combobox$main(p__49966){
var map__49967 = p__49966;
var map__49967__$1 = cljs.core.__destructure_map(map__49967);
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49967__$1,new cljs.core.Keyword(null,"options","options",99638489));
...
return (function (p__49968){
var map__49969 = p__49968;
var map__49969__$1 = cljs.core.__destructure_map(map__49969);
var options__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var clear_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"clear?","clear?",1363344639));
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var list_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"list-classes","list-classes",-1246198045));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49969__$1,new cljs.core.Keyword(null,"label","label",1718410804));
...
}),(function (){var or__4253__auto__ = required_QMARK_;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return false;
...
}),new cljs.core.Keyword(null,"class","class",-2030961996),["absolute flex items-center rounded-r-md ","inset-y-0 right-0 px-2 focus:outline-none "].join('')], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.combobox.combobox_icon], null)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(list_status),new cljs.core.Keyword(null,"open","open",-1763596448)))?new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["absolute overflow-auto rounded-md bg-white ","shadow-lg ring-1 ring-black ring-opacity-5 ","z-10 mt-1 max-h-60 w-full py-1 ","text-base focus:outline-none sm:text-sm ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(list_classes)?list_classes:null))].join(''),new cljs.core.Keyword(null,"id","id",-1388402092),"options",new cljs.core.Keyword(null,"role","role",-736691072),"listbox"], null),(cljs.core.truth_(clear_QMARK_)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),["relative select-none text-gray-500 ","py-1 pl-3 pr-9 text-xs ","hover:bg-gray-100 cursor-pointer ","border-b"].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1("") : on_change.call(null,""));

cljs.core.reset_BANG_(input_value,"");

return close_list();
}),new cljs.core.Keyword(null,"role","role",-736691072),"option",new cljs.core.Keyword(null,"tabIndex","tabIndex",-169286716),"-1"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"block truncate"], null),"Clear"], null)], null):null),(cljs.core.truth_(loading_QMARK_)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"p-small text-xs italic text-gray-500"], null),"loading..."], null):null),((cljs.core.not(loading_QMARK_))?(function (){var iter__4652__auto__ = (function webapp$components$combobox$main_$_iter__49972(s__49973){
return (new cljs.core.LazySeq(null,(function (){
var s__49973__$1 = s__49973;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__49973__$1);
if(temp__5753__auto__){
var s__49973__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49973__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__49973__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__49975 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__49974 = (0);
while(true){
if((i__49974 < size__4651__auto__)){
var option = cljs.core._nth(c__4650__auto__,i__49974);
cljs.core.chunk_append(b__49975,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.combobox.combobox_item,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"item","item",249373802),option,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__49974,option,c__4650__auto__,size__4651__auto__,b__49975,s__49973__$2,temp__5753__auto__,lifecycle_iterable,map__49969,map__49969__$1,options__$1,on_change,clear_QMARK_,required_QMARK_,list_classes,selected,placeholder,on_focus,name,loading_QMARK_,on_blur,size,label,list_status,close_list,open_list,searched_options,input_value,map__49967,map__49967__$1,options){
return (function (value){
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(value) : on_change.call(null,value));

return cljs.core.reset_BANG_(input_value,value);
});})(i__49974,option,c__4650__auto__,size__4651__auto__,b__49975,s__49973__$2,temp__5753__auto__,lifecycle_iterable,map__49969,map__49969__$1,options__$1,on_change,clear_QMARK_,required_QMARK_,list_classes,selected,placeholder,on_focus,name,loading_QMARK_,on_blur,size,label,list_status,close_list,open_list,searched_options,input_value,map__49967,map__49967__$1,options))
,new cljs.core.Keyword(null,"close-list","close-list",-1609015538),close_list,new cljs.core.Keyword(null,"selected","selected",574897764),selected], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),option], null)));

var G__50027 = (i__49974 + (1));
i__49974 = G__50027;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49975),webapp$components$combobox$main_$_iter__49972(cljs.core.chunk_rest(s__49973__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49975),null);
}
} else {
var option = cljs.core.first(s__49973__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.components.combobox.combobox_item,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"item","item",249373802),option,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (option,s__49973__$2,temp__5753__auto__,lifecycle_iterable,map__49969,map__49969__$1,options__$1,on_change,clear_QMARK_,required_QMARK_,list_classes,selected,placeholder,on_focus,name,loading_QMARK_,on_blur,size,label,list_status,close_list,open_list,searched_options,input_value,map__49967,map__49967__$1,options){
return (function (value){
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(value) : on_change.call(null,value));

return cljs.core.reset_BANG_(input_value,value);
});})(option,s__49973__$2,temp__5753__auto__,lifecycle_iterable,map__49969,map__49969__$1,options__$1,on_change,clear_QMARK_,required_QMARK_,list_classes,selected,placeholder,on_focus,name,loading_QMARK_,on_blur,size,label,list_status,close_list,open_list,searched_options,input_value,map__49967,map__49967__$1,options))
,new cljs.core.Keyword(null,"close-list","close-list",-1609015538),close_list,new cljs.core.Keyword(null,"selected","selected",574897764),selected], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),option], null)),webapp$components$combobox$main_$_iter__49972(cljs.core.rest(s__49973__$2)));
}
} else {
return null;
}
