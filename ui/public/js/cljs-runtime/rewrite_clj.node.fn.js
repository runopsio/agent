...
var syms = (function (){var iter__4652__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__39979(s__39980){
return (new cljs.core.LazySeq(null,(function (){
var s__39980__$1 = s__39980;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__39980__$1);
if(temp__5753__auto__){
var s__39980__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39980__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__39980__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__39982 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__39981 = (0);
while(true){
if((i__39981 < size__4651__auto__)){
var i = cljs.core._nth(c__4650__auto__,i__39981);
...
cljs.core.chunk_append(b__39982,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__40184 = (i__39981 + (1));
i__39981 = G__40184;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39982),rewrite_clj$node$fn$fn_walk_$_iter__39979(cljs.core.chunk_rest(s__39980__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39982),null);
}
} else {
var i = cljs.core.first(s__39980__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__39979(cljs.core.rest(s__39980__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__39974_SHARP_){
var or__4253__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__39974_SHARP_);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return p1__39974_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k40034,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k40034,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__40055){
var vec__40056 = p__40055;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40056,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40056,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__40033){
var self__ = this;
var G__40033__$1 = this;
return (new cljs.core.RecordIter((0),G__40033__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this40035,other40036){
var self__ = this;
var this40035__$1 = this;
return (((!((other40036 == null)))) && ((((this40035__$1.constructor === other40036.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40035__$1.children,other40036.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40035__$1.__extmap,other40036.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k40034){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k40034);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__40033){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__40142 = cljs.core.keyword_identical_QMARK_;
var expr__40143 = k__4511__auto__;
if(cljs.core.truth_((pred__40142.cljs$core$IFn$_invoke$arity$2 ? pred__40142.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__40143) : pred__40142.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__40143)))){
return (new rewrite_clj.node.fn.FnNode(G__40033,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__40033),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__40033){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__40033,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__40045){
var extmap__4542__auto__ = (function (){var G__40163 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__40045,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__40045)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__40163);
} else {
return G__40163;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__40045),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
