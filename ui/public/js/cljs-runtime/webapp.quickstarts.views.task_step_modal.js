goog.provide('webapp.quickstarts.views.task_step_modal');
webapp.quickstarts.views.task_step_modal.create_task = (function webapp$quickstarts$views$task_step_modal$create_task(){
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_task], 0));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"create-new-task","create-new-task",494722089),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"script","script",-1304443801),new cljs.core.Keyword(null,"script","script",-1304443801).cljs$core$IFn$_invoke$arity$1(new_task),new cljs.core.Keyword(null,"connection","connection",-123599300),new cljs.core.Keyword(null,"connection","connection",-123599300).cljs$core$IFn$_invoke$arity$1(new_task),new cljs.core.Keyword(null,"message","message",-406056002),new cljs.core.Keyword(null,"description","description",-1428560544).cljs$core$IFn$_invoke$arity$1(new_task)], null)], null));
});
webapp.quickstarts.views.task_step_modal.submit_task_on_keydown = (function webapp$quickstarts$views$task_step_modal$submit_task_on_keydown(e){
...
return webapp.quickstarts.views.task_step_modal.create_task();
} else {
return null;
}
});
webapp.quickstarts.views.task_step_modal.main = (function webapp$quickstarts$views$task_step_modal$main(change_step,connection_name){
var new_task = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("webapp.subs","new-task","webapp.subs/new-task",1755247024)], null)));
...
})(),(function (p1__30516_SHARP_){
return webapp.quickstarts.views.task_step_modal.submit_task_on_keydown(p1__30516_SHARP_);
}),(10),"script_area",(function (p1__30515_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-new-task-script","set-new-task-script",1957710486),p1__30515_SHARP_.target.value], null));
}),"font-mono"]);
var connection_select_config = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"label","label",1718410804),"Connection",new cljs.core.Keyword(null,"selected","selected",574897764),connection_name,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),true,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),connection_name,new cljs.core.Keyword(null,"text","text",-1790561697),connection_name], null)], null)], null);
