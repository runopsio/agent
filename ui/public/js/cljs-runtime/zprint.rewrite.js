...
var G__41925 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__41925;
continue;
} else {
var G__41926 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__41926;
continue;
}
} else {
var G__41927 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__41927;
continue;
}
}
...
var G__41903 = zloc;
var G__41904 = (function (){var G__41905 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__41906 = zloc;
var G__41906__$1 = (((G__41906 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__41906) : rewrite_clj.zip.node.call(null,G__41906)));
if((G__41906__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__41906__$1) : zprint.zutil.edn_STAR_.call(null,G__41906__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__41905) : rewrite_clj.zip.root.call(null,G__41905));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__41903,G__41904) : rewrite_clj.zip.replace.call(null,G__41903,G__41904));
});
/**
...
var G__41928 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__41928;
continue;
}
break;
...
var G__41929 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__41930 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__41929;
out = G__41930;
continue;
} else {
...
var G__41932 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__41933 = cljs.core.next(new_loc);
var G__41934 = replaced_loc;
nloc = G__41932;
new_loc = G__41933;
last_loc = G__41934;
continue;
...
return zprint.rewrite.sort_val((function (){var G__41917 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__41917) : rewrite_clj.zip.down.call(null,G__41917));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__41922_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__41922_SHARP_) : rewrite_clj.zip.tag.call(null,p1__41922_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__41922_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__41922_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
