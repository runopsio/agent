...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k39875,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k39875,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__39880){
var vec__39881 = p__39880;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39881,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39881,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__39874){
var self__ = this;
var G__39874__$1 = this;
return (new cljs.core.RecordIter((0),G__39874__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this39876,other39877){
var self__ = this;
var this39876__$1 = this;
return (((!((other39877 == null)))) && ((((this39876__$1.constructor === other39877.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this39876__$1.children,other39877.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this39876__$1.__extmap,other39877.__extmap)))))));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k39875){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k39875);

}
}));

(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__39874){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__39891 = cljs.core.keyword_identical_QMARK_;
var expr__39892 = k__4511__auto__;
if(cljs.core.truth_((pred__39891.cljs$core$IFn$_invoke$arity$2 ? pred__39891.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__39892) : pred__39891.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__39892)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__39874,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__39874),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__39874){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__39874,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__39878){
var extmap__4542__auto__ = (function (){var G__39903 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__39878,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__39878)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__39903);
} else {
return G__39903;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__39878),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var G__39969 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__39969;
continue;
}
break;
