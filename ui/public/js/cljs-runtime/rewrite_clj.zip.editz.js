...
var G__41004 = (function (){var G__41005 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__41005) : f.call(null,G__41005));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__41004) : rewrite_clj.node.coerce.call(null,G__41004));
});
/**
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__41006_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__41006_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq41007){
var G__41008 = cljs.core.first(seq41007);
var seq41007__$1 = cljs.core.next(seq41007);
var G__41009 = cljs.core.first(seq41007__$1);
var seq41007__$2 = cljs.core.next(seq41007__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41008,G__41009,seq41007__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__41013 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__41013) : str_fn.call(null,G__41013));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__41014 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__41014) : str_fn.call(null,G__41014));
})()):null)));
...
var G__41022 = rewrite_clj.zip.base.tag(zloc);
var G__41022__$1 = (((G__41022 instanceof cljs.core.Keyword))?G__41022.fqn:null);
switch (G__41022__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__41020_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__41020_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__41021_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__41021_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41022__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__41026 = rewrite_clj.zip.base.tag(zloc);
var G__41026__$1 = (((G__41026 instanceof cljs.core.Keyword))?G__41026.fqn:null);
switch (G__41026__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__41024_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__41024_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41026__$1)].join('')));
