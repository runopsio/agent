...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__49748){
...
return clojure.zip.zipper((function (p1__49753_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__49753_SHARP_)) || (cljs.core.map_QMARK_(p1__49753_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__49754){
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49786_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__49786_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49785_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49785_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49788_SHARP_){
return (((p1__49788_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__49788_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__49811,mapping){
var map__49812 = p__49811;
var map__49812__$1 = cljs.core.__destructure_map(map__49812);
var state = map__49812__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49812__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49812__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49812__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49810_SHARP_){
var and__4251__auto__ = (p1__49810_SHARP_ instanceof cljs.core.Symbol);
if(and__4251__auto__){
return cljs.core.namespace(p1__49810_SHARP_);
} else {
...
var G__49892 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__49893 = clojure.zip.next(loc);
loc = G__49893;
continue;
}
}
...
var G__49898 = (i__4865__auto___49897 + (1));
i__4865__auto___49897 = G__49898;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__49837){
var vec__49838 = p__49837;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49838,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq49822){
var G__49823 = cljs.core.first(seq49822);
var seq49822__$1 = cljs.core.next(seq49822);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49823,seq49822__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__49841_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49841_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__49845_49903 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__49846_49904 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__49847_49905 = true;
var _STAR_print_fn_STAR__temp_val__49848_49906 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__49847_49905);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__49848_49906);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__49846_49904);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__49845_49903);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4795__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__49844_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__49844_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__49907 = cljs.core.next(opts__$1);
var G__49908 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__49907;
acc = G__49908;
continue;
} else {
if(typeof f === 'string'){
var G__49909 = cljs.core.next(opts__$1);
var G__49910 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__49909;
acc = G__49910;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__49911 = cljs.core.nnext(opts__$1);
var G__49912 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__49911;
acc = G__49912;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__49913 = cljs.core.next(opts__$1);
var G__49914 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__49913;
acc = G__49914;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__49855 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__49855.cljs$core$IFn$_invoke$arity$1 ? fexpr__49855.cljs$core$IFn$_invoke$arity$1(f) : fexpr__49855.call(null,f));
})())){
var G__49915 = cljs.core.next(opts__$1);
var G__49916 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__49915;
acc = G__49916;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__49857 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__49857.cljs$core$IFn$_invoke$arity$1 ? fexpr__49857.cljs$core$IFn$_invoke$arity$1(f) : fexpr__49857.call(null,f));
})())){
var G__49917 = cljs.core.nnext(opts__$1);
var G__49918 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__49917;
acc = G__49918;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__49919 = cljs.core.next(opts__$1);
var G__49920 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__49919;
acc = G__49920;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__49859){
var vec__49860 = p__49859;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49860,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49860,(1),null);
...
var G__49865 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__49864 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__49864.cljs$core$IFn$_invoke$arity$1 ? fexpr__49864.cljs$core$IFn$_invoke$arity$1(G__49865) : fexpr__49864.call(null,G__49865));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__49870 = quoted_form;
var G__49871 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__49870,G__49871) : day8.re_frame.debux.common.util.remove_d.call(null,G__49870,G__49871));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__49876 = quoted_form;
var G__49877 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__49876,G__49877) : day8.re_frame.debux.common.util.remove_d.call(null,G__49876,G__49877));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__49921__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__49884 = quoted_form;
var G__49885 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__49884,G__49885) : day8.re_frame.debux.common.util.remove_d.call(null,G__49884,G__49885));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__49922__i < G__49922__a.length) {G__49922__a[G__49922__i] = arguments[G__49922__i + 0]; ++G__49922__i;}
  arg = new cljs.core.IndexedSeq(G__49922__a,0,null);
} 
return G__49921__delegate.call(this,arg);};
G__49921.cljs$lang$maxFixedArity = 0;
G__49921.cljs$lang$applyTo = (function (arglist__49923){
var arg = cljs.core.seq(arglist__49923);
return G__49921__delegate(arg);
});
...
var G__49924 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__49924;
continue;
} else {
...
var G__49925 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__49925;
continue;
} else {
var G__49926 = clojure.zip.next(loc);
loc = G__49926;
continue;
