...
isFailedOwnDelivery||(hasIntegration=currentHub.getClient(),data=void 0===error&&utils_1.isString(data.msg)?_this._eventFromIncompleteOnError(data.msg,data.url,data.line,data.column):_this._enhanceEventWithInitialFrame(eventbuilder_1.eventFromUnknownInput(error||data.msg,void 0,{attachStacktrace:hasIntegration&&hasIntegration.getOptions().attachStacktrace,rejection:!1}),data.url,data.line,data.column),utils_1.addExceptionMechanism(data,{handled:!1,type:"onerror"}),currentHub.captureEvent(data,{originalException:error}))},
