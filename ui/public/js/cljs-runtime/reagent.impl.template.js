...
var G__37349 = o;
reagent.impl.template.goog$module$goog$object.set(G__37349,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37376__delegate = function (args){
...
while (G__37377__i < G__37377__a.length) {G__37377__a[G__37377__i] = arguments[G__37377__i + 0]; ++G__37377__i;}
  args = new cljs.core.IndexedSeq(G__37377__a,0,null);
} 
return G__37376__delegate.call(this,args);};
G__37376.cljs$lang$maxFixedArity = 0;
G__37376.cljs$lang$applyTo = (function (arglist__37378){
var args = cljs.core.seq(arglist__37378);
return G__37376__delegate(args);
});
...
var G__37350 = o;
reagent.impl.template.goog$module$goog$object.set(G__37350,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37379__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37380__i < G__37380__a.length) {G__37380__a[G__37380__i] = arguments[G__37380__i + 0]; ++G__37380__i;}
  args = new cljs.core.IndexedSeq(G__37380__a,0,null);
} 
...
var args = cljs.core.seq(arglist__37381);
...
var G__37351 = props;
var G__37351__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37351,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37351);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37351__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37352 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37352,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37352;
}
})(),id_class);
...
var G__37353 = (cljs.core.count(argv) - first_child);
switch (G__37353) {
case (0):
...
var vec__37354 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37354,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37354,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37354,(2),null);
...
var temp__5757__auto___37389 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37389 == null)){
} else {
var key_37390 = temp__5757__auto___37389;
(jsprops.key = key_37390);
}
...
var temp__5757__auto___37391 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37391 == null)){
} else {
var key_37392 = temp__5757__auto___37391;
(jsprops.key = key_37392);
}
...
var temp__5757__auto___37393 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___37393 == null)){
} else {
var key_37394 = temp__5757__auto___37393;
(jsprops.key = key_37394);
}
...
var temp__5757__auto___37395 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37395 == null)){
} else {
var key_37396 = temp__5757__auto___37395;
(jsprops.key = key_37396);
}
...
var temp__5757__auto___37397 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37397 == null)){
} else {
var key_37398 = temp__5757__auto___37397;
(jsprops.key = key_37398);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37357_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37357_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37362 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37362,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37362,(1),null);
...
break;
default:
var G__37402 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37403 = compiler;
v = G__37402;
compiler = G__37403;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37373 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37373 = (function (opts,id,fn_to_element,parse_fn,meta37374){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37373.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37375,meta37374__$1){
var self__ = this;
var _37375__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37373(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37374__$1));
}));

(reagent.impl.template.t_reagent$impl$template37373.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37375){
var self__ = this;
var _37375__$1 = this;
return self__.meta37374;
}));

(reagent.impl.template.t_reagent$impl$template37373.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37373.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37373.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37373.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37373.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37373.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37374","meta37374",961585523,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37373.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37373.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37373");

(reagent.impl.template.t_reagent$impl$template37373.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template37373");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37373.
 */
reagent.impl.template.__GT_t_reagent$impl$template37373 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37373(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37374){
return (new reagent.impl.template.t_reagent$impl$template37373(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37374));
});

}

return (new reagent.impl.template.t_reagent$impl$template37373(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
