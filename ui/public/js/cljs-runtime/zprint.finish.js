...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__39638_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__39638_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__39638_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__39643){
var vec__39644 = p__39643;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39644,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39644,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__39650,s,color,element,idx){
var map__39651 = p__39650;
var map__39651__$1 = cljs.core.__destructure_map(map__39651);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39651__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39651__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39651__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__39654 = (function (){var or__4253__auto__ = color;
...
var fexpr__39653 = (function (){var G__39655 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__39655) : style_map.call(null,G__39655));
})();
return (fexpr__39653.cljs$core$IFn$_invoke$arity$1 ? fexpr__39653.cljs$core$IFn$_invoke$arity$1(G__39654) : fexpr__39653.call(null,G__39654));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__39657){
var vec__39658 = p__39657;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39658,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39658,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39658,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__39661){
var vec__39662 = p__39661;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39662,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39662,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39662,(2),null);
...
var G__39765 = cljs.core.next(ssv);
var G__39766 = (this_ssv == null);
var G__39767 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__39768 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__39765;
doing_nil_QMARK_ = G__39766;
last_elide = G__39767;
out = G__39768;
continue;
}
...
var vec__39672 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39672,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39672,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39672,(2),null);
...
var G__39770 = cljs.core.next(remaining_cvec);
var G__39771 = new_idx;
var G__39772 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__39770;
idx = G__39771;
out = G__39772;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__39685,cursor_vec){
var vec__39686 = p__39685;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39686,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39686,(1),null);
var focus_vec = vec__39686;
...
var vec__39689 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39689,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39689,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__39692){
var vec__39693 = p__39692;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39693,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39693,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__39700,existing_count){
var vec__39701 = p__39700;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39701,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39701,(1),null);
...
return cljs.core.filterv((function (p1__39696_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__39696_SHARP_))));
...
var vec__39715 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39715,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39715,(1),null);
var cvec_element = vec__39715;
if((cvec_element == null)){
var G__39794 = cljs.core.next(cvec_nl);
var G__39795 = (idx + (1));
var G__39796 = start;
var G__39797 = out;
cvec_nl = G__39794;
...
var G__39798 = cljs.core.next(cvec_nl);
var G__39799 = (idx + (1));
var G__39800 = idx;
var G__39801 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__39798;
idx = G__39799;
start = G__39800;
out = G__39801;
...
var G__39803 = cljs.core.next(cvec_nl);
var G__39804 = (idx + (1));
var G__39805 = (idx + (1));
var G__39806 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__39803;
idx = G__39804;
start = G__39805;
out = G__39806;
...
var G__39807 = cljs.core.next(cvec_nl);
var G__39808 = (idx + (1));
var G__39809 = idx;
var G__39810 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__39807;
idx = G__39808;
start = G__39809;
out = G__39810;
...
var G__39811 = cljs.core.next(cvec_nl);
var G__39812 = (idx + (1));
var G__39813 = start;
var G__39814 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__39811;
idx = G__39812;
start = G__39813;
out = G__39814;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__39730_SHARP_,p2__39729_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__39729_SHARP_)){
return cljs.core.reduced(p1__39730_SHARP_);
} else {
return (p1__39730_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__39736,p__39737){
var vec__39738 = p__39736;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39738,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39738,(1),null);
var vec__39741 = p__39737;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39741,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39741,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__39751,cvec,focus_vec){
var map__39752 = p__39751;
var map__39752__$1 = cljs.core.__destructure_map(map__39752);
var options = map__39752__$1;
var map__39753 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39752__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__39753__$1 = cljs.core.__destructure_map(map__39753);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39753__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39753__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39753__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39750_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__39750_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
