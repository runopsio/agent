...
var o30877 = temp__5751__auto__;
var temp__5751__auto____$1 = (o30877["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o30878 = temp__5751__auto____$1;
return (o30878["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25484__auto__ = f;
return (o__25484__auto__["toString"]).call(o__25484__auto__);
} else {
return "";
}
...
try{var o__25484__auto___31047 = t;
(o__25484__auto___31047["cljs$lang$ctorPrWriter"]).call(o__25484__auto___31047,t,writer);
}catch (e30902){var __31048 = e30902;
}
...
var char_code = (function (){var o__25484__auto__ = (new String(char$));
return (o__25484__auto__["charCodeAt"]).call(o__25484__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25484__auto__ = String;
return (o__25484__auto__["fromCharCode"]).call(o__25484__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30929 = num_code;
switch (G__30929) {
case (1):
return (185);
...
var o__25484__auto__ = String;
return (o__25484__auto__["fromCharCode"]).call(o__25484__auto__,superscript_code);
});
/**
...
}catch (e30933){var _e__25491__auto__ = e30933;
return false;
}})())){
...
var vec__30936 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30936,(0),null);
...
var len__4864__auto___31055 = arguments.length;
var i__4865__auto___31057 = (0);
while(true){
if((i__4865__auto___31057 < len__4864__auto___31055)){
args__4870__auto__.push((arguments[i__4865__auto___31057]));

var G__31058 = (i__4865__auto___31057 + (1));
i__4865__auto___31057 = G__31058;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30948){
var vec__30949 = p__30948;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30949,(0),null);
...
var G__31061 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__31062 = cljs.core.butlast(remaining_tokens);
name_tokens = G__31061;
remaining_tokens = G__31062;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30946){
var G__30947 = cljs.core.first(seq30946);
var seq30946__$1 = cljs.core.next(seq30946);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30947,seq30946__$1);
}));
...
var vec__30954 = cljs.core.split_with((function (p1__30953_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30953_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30954,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30954,(1),null);
...
var vec__30960 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30960,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30960,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__31069 = cljs.core.rest(remaining_tokens);
var G__31070 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__31069;
name_tokens = G__31070;
continue;
} else {
...
var vec__30965 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30965,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30965,(1),null);
var vec__30968 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30968,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30968,(1),null);
var vec__30971 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30971,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30971,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30971,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30971,(3),null);
...
var vec__30976 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30976,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30976,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30976,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30976,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30976,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30976,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__30979 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30979,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30979,(1),null);
var vec__30982 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30982,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30982,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30985 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30985) : devtools.munging.parse_fn_info_deep.call(null,G__30985));
})()));
}
} else {
return fn_info;
...
var G__31092 = (arity + (1));
var G__31093 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30990){
var vec__30991 = p__30990;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30991,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30991,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30996_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30996_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30997_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30997_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___31098 = arguments.length;
var i__4865__auto___31099 = (0);
while(true){
if((i__4865__auto___31099 < len__4864__auto___31098)){
args__4870__auto__.push((arguments[i__4865__auto___31099]));

var G__31100 = (i__4865__auto___31099 + (1));
i__4865__auto___31099 = G__31100;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__31001){
var vec__31002 = p__31001;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31002,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30999){
var G__31000 = cljs.core.first(seq30999);
var seq30999__$1 = cljs.core.next(seq30999);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31000,seq30999__$1);
}));
...
var map__31006 = options;
var map__31006__$1 = cljs.core.__destructure_map(map__31006);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31006__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31006__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31006__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31006__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__31007 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31007,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31007,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31007,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31007,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31007,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31007,(5),null);
...
var o__25484__auto__ = f;
return (o__25484__auto__["getBasis"]).call(o__25484__auto__);
});
/**
...
}catch (e31010){var _e__25491__auto__ = e31010;
...
var G__31111 = (obj[cljs.core.first(path)]);
var G__31112 = cljs.core.rest(path);
obj = G__31111;
path = G__31112;
continue;
} else {
...
var _STAR_ = (function (accum,p__31014){
var vec__31015 = p__31014;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31015,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31015,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31019){
var vec__31020 = p__31019;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31020,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31020,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31020,(2),null);
...
var post_process = (function (p__31037){
var vec__31038 = p__31037;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31038,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31038,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31033_SHARP_){
return (obj[cljs.core.first(p1__31033_SHARP_)]);
}),sorted_matches);
