...
if((c === "\n")){
var G__40643 = escape_QMARK_;
var G__40644 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__40643;
lines = G__40644;
continue;
} else {
buf.append(c);

var G__40645 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__40646 = lines;
escape_QMARK_ = G__40645;
lines = G__40646;
continue;
...
var G__40595 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__40595) : rewrite_clj.node.string_node.call(null,G__40595));
});
...
var G__40609 = cljs.core.re_pattern(regex);
var G__40610 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__40609,G__40610) : rewrite_clj.node.token_node.call(null,G__40609,G__40610));
});
