...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k40338,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k40338,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__40343){
var vec__40344 = p__40343;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40344,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40344,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__40337){
var self__ = this;
var G__40337__$1 = this;
return (new cljs.core.RecordIter((0),G__40337__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this40339,other40340){
var self__ = this;
var this40339__$1 = this;
return (((!((other40340 == null)))) && ((((this40339__$1.constructor === other40340.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40339__$1.value,other40340.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40339__$1.string_value,other40340.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40339__$1.__extmap,other40340.__extmap)))))))));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k40338){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k40338);

}
}));

(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__40337){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__40367 = cljs.core.keyword_identical_QMARK_;
var expr__40368 = k__4511__auto__;
if(cljs.core.truth_((pred__40367.cljs$core$IFn$_invoke$arity$2 ? pred__40367.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__40368) : pred__40367.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__40368)))){
return (new rewrite_clj.node.token.TokenNode(G__40337,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__40367.cljs$core$IFn$_invoke$arity$2 ? pred__40367.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__40368) : pred__40367.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__40368)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__40337,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__40337),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__40337){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__40337,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__40341){
var extmap__4542__auto__ = (function (){var G__40372 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__40341,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__40341)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__40372);
} else {
return G__40372;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__40341),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__40341),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
