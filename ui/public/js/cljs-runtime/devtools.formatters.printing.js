...
var len__4864__auto___31210 = arguments.length;
var i__4865__auto___31211 = (0);
while(true){
if((i__4865__auto___31211 < len__4864__auto___31210)){
args__4870__auto__.push((arguments[i__4865__auto___31211]));

var G__31212 = (i__4865__auto___31211 + (1));
i__4865__auto___31211 = G__31212;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31134){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31135,G__31136,seq31134__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31145_SHARP_){
return (!((cljs.core.meta(p1__31145_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31160__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31161){var _e__25491__auto__ = e31161;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e31163){var _e__25491__auto__ = e31163;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31193 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31194 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31194);

try{var map__31196 = opts;
var map__31196__$1 = cljs.core.__destructure_map(map__31196);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31196__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31193);
}});
...
var temp__5751__auto___31228 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___31228)){
var managed_print_level_31229 = temp__5751__auto___31228;
var _STAR_print_level_STAR__orig_val__31205_31230 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31206_31231 = managed_print_level_31229;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31206_31231);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31198_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31198_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31205_31230);
}} else {
job_fn();
}
