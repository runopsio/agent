...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k40180,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k40180,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__40186){
var vec__40187 = p__40186;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40187,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40187,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__40179){
var self__ = this;
var G__40179__$1 = this;
return (new cljs.core.RecordIter((0),G__40179__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this40181,other40182){
var self__ = this;
var this40181__$1 = this;
return (((!((other40182 == null)))) && ((((this40181__$1.constructor === other40182.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40181__$1.tag,other40182.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40181__$1.wrap_fn,other40182.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40181__$1.wrap_length,other40182.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40181__$1.seq_fn,other40182.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40181__$1.children,other40182.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40181__$1.__extmap,other40182.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__40196 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__40196) : self__.seq_fn.call(null,G__40196));
}));
...
var self__ = this;
var this$__$1 = this;
var G__40202 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__40202) : self__.wrap_fn.call(null,G__40202));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k40180){
var self__ = this;
var this__4509__auto____$1 = this;
var G__40208 = k40180;
var G__40208__$1 = (((G__40208 instanceof cljs.core.Keyword))?G__40208.fqn:null);
switch (G__40208__$1) {
case "tag":
case "wrap-fn":
case "wrap-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k40180);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__40179){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__40216 = cljs.core.keyword_identical_QMARK_;
var expr__40217 = k__4511__auto__;
if(cljs.core.truth_((pred__40216.cljs$core$IFn$_invoke$arity$2 ? pred__40216.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__40217) : pred__40216.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__40217)))){
return (new rewrite_clj.node.seq.SeqNode(G__40179,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__40216.cljs$core$IFn$_invoke$arity$2 ? pred__40216.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__40217) : pred__40216.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__40217)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__40179,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__40216.cljs$core$IFn$_invoke$arity$2 ? pred__40216.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__40217) : pred__40216.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__40217)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__40179,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__40216.cljs$core$IFn$_invoke$arity$2 ? pred__40216.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__40217) : pred__40216.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__40217)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__40179,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__40216.cljs$core$IFn$_invoke$arity$2 ? pred__40216.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__40217) : pred__40216.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__40217)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__40179,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__40179),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__40179){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__40179,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__40183){
var extmap__4542__auto__ = (function (){var G__40265 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__40183,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__40183)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__40265);
} else {
return G__40265;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__40183),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__40183),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__40183),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__40183),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__40183),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__40273_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__40273_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__40294_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__40294_SHARP_);
}),children);
});
