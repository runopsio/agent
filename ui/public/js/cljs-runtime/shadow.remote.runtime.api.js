...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44134 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44134(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_44136 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_44136(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_44138 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_44138(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_44144 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_44144(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44148 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44148(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44153 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44153(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__44107,callback){
var map__44108 = p__44107;
var map__44108__$1 = cljs.core.__destructure_map(map__44108);
var input = map__44108__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44108__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44108__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
