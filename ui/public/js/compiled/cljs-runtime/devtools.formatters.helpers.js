...
var G__57176 = devtools.prefs.pref(v);
v = G__57176;
continue;
} else {
return v;
...
}catch (e57119){var _e__38955__auto__ = e57119;
return false;
}})();
...
}catch (e57123){var _e__38955__auto__ = e57123;
return false;
}})();
...
}catch (e57128){var _e__38955__auto__ = e57128;
return false;
}}
}
});
...
var vec__57143 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57143,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57143,(1),null);
...
return cljs.core.some((function (p1__57153_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__57153_SHARP_);
}),template);
});
