...
return [(function (){var pred__60343 = cljs.core.instance_QMARK_;
var expr__60344 = reactive_val;
if(cljs.core.truth_((pred__60343.cljs$core$IFn$_invoke$arity$2 ? pred__60343.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__60344) : pred__60343.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__60344)))){
return "ra";
} else {
if(cljs.core.truth_((pred__60343.cljs$core$IFn$_invoke$arity$2 ? pred__60343.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__60344) : pred__60343.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__60344)))){
return "rc";
} else {
if(cljs.core.truth_((pred__60343.cljs$core$IFn$_invoke$arity$2 ? pred__60343.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__60344) : pred__60343.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__60344)))){
return "rx";
} else {
if(cljs.core.truth_((pred__60343.cljs$core$IFn$_invoke$arity$2 ? pred__60343.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__60344) : pred__60343.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__60344)))){
return "tr";
} else {
return "other";
}
