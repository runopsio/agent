...
var vec__69281 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__69284 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69284,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69284,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69281,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69281,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__69287){
var vec__69288 = p__69287;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69288,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69288,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69291,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69291,(1),null);
...
var vec__69301 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69301,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69301,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69301,(2),null);
var vec__69304 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69304,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69304,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69304,(2),null);
...
var G__69307 = special_option;
var G__69307__$1 = (((G__69307 instanceof cljs.core.Keyword))?G__69307.fqn:null);
switch (G__69307__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__69308){
var vec__69309 = p__69308;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69309,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69309,(1),null);
...
var vec__69312 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69312,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69312,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69312,(2),null);
...
var vec__69318 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69318,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69318,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69318,(2),null);
var tuple = vec__69318;
...
var G__69385 = cljs.core.next(style_vec);
var G__69386 = ends_w_blanks_QMARK_;
var G__69387 = tuple;
var G__69388 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__69385;
previous_ends_w_blanks_QMARK_ = G__69386;
previous_tuple = G__69387;
out = G__69388;
continue;
}
break;
...
var len__4864__auto___69389 = arguments.length;
var i__4865__auto___69390 = (0);
while(true){
if((i__4865__auto___69390 < len__4864__auto___69389)){
args__4870__auto__.push((arguments[i__4865__auto___69390]));

var G__69391 = (i__4865__auto___69390 + (1));
i__4865__auto___69390 = G__69391;
continue;
} else {
}
break;
...
var vec__69324 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69324,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69324,(1),null);
...
var result = (function (){var G__69327 = zprint.core.parse_string_all_options(rest_options);
var G__69328 = zprint.core.zprint_str_internal;
var G__69329 = ":parse-string-all? call";
var G__69330 = (function (){var G__69331 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__69331) : zprint.zutil.edn_STAR_.call(null,G__69331));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__69327,G__69328,G__69329,G__69330) : zprint.core.process_multiple_forms.call(null,G__69327,G__69328,G__69329,G__69330));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__69332 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69332,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69332,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq69321){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69322,G__69323,seq69321__$2);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___69415 = arguments.length;
var i__4865__auto___69419 = (0);
while(true){
if((i__4865__auto___69419 < len__4864__auto___69415)){
args__4870__auto__.push((arguments[i__4865__auto___69419]));

var G__69420 = (i__4865__auto___69419 + (1));
i__4865__auto___69419 = G__69420;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq69336){
var G__69337 = cljs.core.first(seq69336);
var seq69336__$1 = cljs.core.next(seq69336);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69337,seq69336__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___69421 = arguments.length;
var i__4865__auto___69422 = (0);
while(true){
if((i__4865__auto___69422 < len__4864__auto___69421)){
args__4870__auto__.push((arguments[i__4865__auto___69422]));

var G__69423 = (i__4865__auto___69422 + (1));
i__4865__auto___69422 = G__69423;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq69338){
var G__69339 = cljs.core.first(seq69338);
var seq69338__$1 = cljs.core.next(seq69338);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69339,seq69338__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___69424 = arguments.length;
var i__4865__auto___69425 = (0);
while(true){
if((i__4865__auto___69425 < len__4864__auto___69424)){
args__4870__auto__.push((arguments[i__4865__auto___69425]));

var G__69426 = (i__4865__auto___69425 + (1));
i__4865__auto___69425 = G__69426;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq69340){
var G__69341 = cljs.core.first(seq69340);
var seq69340__$1 = cljs.core.next(seq69340);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69341,seq69340__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___69427 = arguments.length;
var i__4865__auto___69428 = (0);
while(true){
if((i__4865__auto___69428 < len__4864__auto___69427)){
args__4870__auto__.push((arguments[i__4865__auto___69428]));

var G__69429 = (i__4865__auto___69428 + (1));
i__4865__auto___69428 = G__69429;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq69342){
var G__69343 = cljs.core.first(seq69342);
var seq69342__$1 = cljs.core.next(seq69342);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69343,seq69342__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__69346,form){
var vec__69347 = p__69346;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69347,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69347,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69347,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69347,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__69350 = (cljs.core.truth_((function (){var and__4251__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4251__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69350,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69350,(1),null);
...
var G__69437 = cljs.core.next(sos);
var G__69438 = comment_QMARK_;
var G__69439 = (function (){var or__4253__auto__ = (!(empty_string_QMARK_));
if(or__4253__auto__){
return or__4253__auto__;
} else {
...
var G__69440 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__69437;
previous_comment_QMARK_ = G__69438;
start_interpolating_QMARK_ = G__69439;
out = G__69440;
continue;
}
break;
...
try{var vec__69357 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69357,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69357,(1),null);
...
var vec__69360 = (cljs.core.truth_((function (){var or__4253__auto__ = range_start__$1;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69360,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69360,(1),null);
...
var vec__69363 = (cljs.core.truth_((function (){var and__4251__auto__ = actual_start;
if(cljs.core.truth_(and__4251__auto__)){
return actual_end;
} else {
return and__4251__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69363,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69363,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69363,(2),null);
...
var forms = (function (){var G__69370 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__69370) : zprint.zutil.edn_STAR_.call(null,G__69370));
})();
