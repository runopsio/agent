...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__75632){
var vec__75633 = p__75632;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75633,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75633,(1),null);
...
return clojure.zip.zipper((function (p1__75636_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__75636_SHARP_)) || (cljs.core.map_QMARK_(p1__75636_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__75637){
var vec__75638 = p__75637;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75638,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75638,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75643_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__75643_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__75642_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__75642_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75644_SHARP_){
return (((p1__75644_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__75644_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__75650,mapping){
var map__75651 = p__75650;
var map__75651__$1 = cljs.core.__destructure_map(map__75651);
var state = map__75651__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75651__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75651__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75651__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75649_SHARP_){
var and__4251__auto__ = (p1__75649_SHARP_ instanceof cljs.core.Symbol);
if(and__4251__auto__){
return cljs.core.namespace(p1__75649_SHARP_);
} else {
...
var G__75734 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__75735 = clojure.zip.next(loc);
loc = G__75735;
continue;
}
}
...
var len__4864__auto___75740 = arguments.length;
var i__4865__auto___75742 = (0);
while(true){
if((i__4865__auto___75742 < len__4864__auto___75740)){
args__4870__auto__.push((arguments[i__4865__auto___75742]));

var G__75743 = (i__4865__auto___75742 + (1));
i__4865__auto___75742 = G__75743;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__75660){
var vec__75664 = p__75660;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75664,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq75657){
var G__75658 = cljs.core.first(seq75657);
var seq75657__$1 = cljs.core.next(seq75657);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__75658,seq75657__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__75670_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__75670_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__75676_75744 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__75677_75745 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__75678_75746 = true;
var _STAR_print_fn_STAR__temp_val__75679_75747 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__75678_75746);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__75679_75747);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__75677_75745);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__75676_75744);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4795__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__75675_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__75675_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__75748 = cljs.core.next(opts__$1);
var G__75749 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__75748;
acc = G__75749;
continue;
} else {
if(typeof f === 'string'){
var G__75750 = cljs.core.next(opts__$1);
var G__75751 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__75750;
acc = G__75751;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__75752 = cljs.core.nnext(opts__$1);
var G__75753 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__75752;
acc = G__75753;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__75754 = cljs.core.next(opts__$1);
var G__75755 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__75754;
acc = G__75755;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__75698 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__75698.cljs$core$IFn$_invoke$arity$1 ? fexpr__75698.cljs$core$IFn$_invoke$arity$1(f) : fexpr__75698.call(null,f));
})())){
var G__75757 = cljs.core.next(opts__$1);
var G__75758 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__75757;
acc = G__75758;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__75700 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__75700.cljs$core$IFn$_invoke$arity$1 ? fexpr__75700.cljs$core$IFn$_invoke$arity$1(f) : fexpr__75700.call(null,f));
})())){
var G__75759 = cljs.core.nnext(opts__$1);
var G__75760 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__75759;
acc = G__75760;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__75762 = cljs.core.next(opts__$1);
var G__75763 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__75762;
acc = G__75763;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__75701){
var vec__75703 = p__75701;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75703,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75703,(1),null);
...
var G__75708 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__75707 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__75707.cljs$core$IFn$_invoke$arity$1 ? fexpr__75707.cljs$core$IFn$_invoke$arity$1(G__75708) : fexpr__75707.call(null,G__75708));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__75714 = quoted_form;
var G__75715 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__75714,G__75715) : day8.re_frame.debux.common.util.remove_d.call(null,G__75714,G__75715));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__75716 = quoted_form;
var G__75717 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__75716,G__75717) : day8.re_frame.debux.common.util.remove_d.call(null,G__75716,G__75717));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__75774__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__75719 = quoted_form;
var G__75720 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__75719,G__75720) : day8.re_frame.debux.common.util.remove_d.call(null,G__75719,G__75720));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__75774 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__75775__i = 0, G__75775__a = new Array(arguments.length -  0);
while (G__75775__i < G__75775__a.length) {G__75775__a[G__75775__i] = arguments[G__75775__i + 0]; ++G__75775__i;}
  arg = new cljs.core.IndexedSeq(G__75775__a,0,null);
} 
return G__75774__delegate.call(this,arg);};
G__75774.cljs$lang$maxFixedArity = 0;
G__75774.cljs$lang$applyTo = (function (arglist__75776){
var arg = cljs.core.seq(arglist__75776);
return G__75774__delegate(arg);
});
G__75774.cljs$core$IFn$_invoke$arity$variadic = G__75774__delegate;
return G__75774;
})()
;
});
...
var G__75778 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__75778;
continue;
} else {
...
var G__75781 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__75781;
continue;
} else {
var G__75783 = clojure.zip.next(loc);
loc = G__75783;
continue;
