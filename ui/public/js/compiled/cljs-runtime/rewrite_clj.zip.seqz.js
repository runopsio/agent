...
var G__67057 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__67057__$1 = (((G__67057 == null))?null:cljs.core.iterate((function (loc){
...
var G__67057__$2 = (((G__67057__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__67057__$1));
var G__67057__$3 = (((G__67057__$2 == null))?null:cljs.core.last(G__67057__$2));
if((G__67057__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__67057__$3);
}
} else {
return zloc;
}
...
var G__67064 = rewrite_clj.zip.move.right(v);
var G__67065 = rewrite_clj.zip.move.up(v);
loc = G__67064;
parent = G__67065;
continue;
} else {
var G__67066 = rewrite_clj.zip.move.right(v0);
var G__67067 = parent;
loc = G__67066;
parent = G__67067;
continue;
...
var G__67068 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__67069 = rewrite_clj.zip.move.up(v);
loc = G__67068;
parent = G__67069;
continue;
} else {
var G__67070 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__67071 = parent;
loc = G__67070;
parent = G__67071;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__67059 = zloc;
var G__67059__$1 = (((G__67059 == null))?null:rewrite_clj.zip.move.down(G__67059));
var G__67059__$2 = (((G__67059__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__67059__$1,k));
if((G__67059__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__67059__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__67060 = rewrite_clj.zip.move.down(zloc);
var G__67060__$1 = (((G__67060 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__67060));
if((G__67060__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__67060__$1);
}
})(),k);
}
});
