...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__60486){
var map__60487 = p__60486;
var map__60487__$1 = cljs.core.__destructure_map(map__60487);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60487__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60487__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60487__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60487__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__60488_60519 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__60489_60520 = null;
var count__60490_60521 = (0);
var i__60491_60522 = (0);
while(true){
if((i__60491_60522 < count__60490_60521)){
var vec__60504_60523 = chunk__60489_60520.cljs$core$IIndexed$_nth$arity$2(null,i__60491_60522);
var k_60524 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60504_60523,(0),null);
var cb_60525 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60504_60523,(1),null);
try{var G__60508_60526 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_60525.cljs$core$IFn$_invoke$arity$1 ? cb_60525.cljs$core$IFn$_invoke$arity$1(G__60508_60526) : cb_60525.call(null,G__60508_60526));
}catch (e60507){var e_60527 = e60507;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_60524,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_60527], 0));
}

var G__60528 = seq__60488_60519;
var G__60529 = chunk__60489_60520;
var G__60530 = count__60490_60521;
var G__60531 = (i__60491_60522 + (1));
seq__60488_60519 = G__60528;
chunk__60489_60520 = G__60529;
count__60490_60521 = G__60530;
i__60491_60522 = G__60531;
continue;
} else {
var temp__5753__auto___60532 = cljs.core.seq(seq__60488_60519);
if(temp__5753__auto___60532){
var seq__60488_60533__$1 = temp__5753__auto___60532;
if(cljs.core.chunked_seq_QMARK_(seq__60488_60533__$1)){
var c__4679__auto___60534 = cljs.core.chunk_first(seq__60488_60533__$1);
var G__60535 = cljs.core.chunk_rest(seq__60488_60533__$1);
var G__60536 = c__4679__auto___60534;
var G__60537 = cljs.core.count(c__4679__auto___60534);
var G__60538 = (0);
seq__60488_60519 = G__60535;
chunk__60489_60520 = G__60536;
count__60490_60521 = G__60537;
i__60491_60522 = G__60538;
continue;
} else {
var vec__60509_60539 = cljs.core.first(seq__60488_60533__$1);
var k_60540 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60509_60539,(0),null);
var cb_60541 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60509_60539,(1),null);
try{var G__60513_60542 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_60541.cljs$core$IFn$_invoke$arity$1 ? cb_60541.cljs$core$IFn$_invoke$arity$1(G__60513_60542) : cb_60541.call(null,G__60513_60542));
}catch (e60512){var e_60543 = e60512;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_60540,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_60543], 0));
}

var G__60544 = cljs.core.next(seq__60488_60533__$1);
var G__60545 = null;
var G__60546 = (0);
var G__60547 = (0);
seq__60488_60519 = G__60544;
chunk__60489_60520 = G__60545;
count__60490_60521 = G__60546;
i__60491_60522 = G__60547;
continue;
}
} else {
}
