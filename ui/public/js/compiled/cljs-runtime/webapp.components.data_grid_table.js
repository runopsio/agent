...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(_BANG_ref,cljs.core.assoc,new cljs.core.Keyword(null,"current","current",-1088038603),(new module$node_modules$$datagridxl$datagridxl2$datagridxl$datagridxl2_umd(new cljs.core.Keyword(null,"current","current",-1088038603).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_BANG_ref)),cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"data","data",-232669377),body,new cljs.core.Keyword(null,"columns","columns",1998437288),head_formatted], null)))));
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full h-5/6 border",new cljs.core.Keyword(null,"ref","ref",1289896967),(function (el){
