...
var G__67745 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__67745;
continue;
} else {
var G__67746 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__67746;
continue;
}
} else {
var G__67747 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__67747;
continue;
}
}
...
var G__67719 = zloc;
var G__67720 = (function (){var G__67721 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__67722 = zloc;
var G__67722__$1 = (((G__67722 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__67722) : rewrite_clj.zip.node.call(null,G__67722)));
if((G__67722__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__67722__$1) : zprint.zutil.edn_STAR_.call(null,G__67722__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__67721) : rewrite_clj.zip.root.call(null,G__67721));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__67719,G__67720) : rewrite_clj.zip.replace.call(null,G__67719,G__67720));
});
/**
...
var G__67751 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__67751;
continue;
}
break;
...
var G__67752 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__67753 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__67752;
out = G__67753;
continue;
} else {
...
var G__67754 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__67755 = cljs.core.next(new_loc);
var G__67756 = replaced_loc;
nloc = G__67754;
new_loc = G__67755;
last_loc = G__67756;
continue;
...
return zprint.rewrite.sort_val((function (){var G__67736 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__67736) : rewrite_clj.zip.down.call(null,G__67736));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__67742_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__67742_SHARP_) : rewrite_clj.zip.tag.call(null,p1__67742_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__67742_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__67742_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
