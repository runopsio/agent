...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k65902,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65902,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__65916){
var vec__65918 = p__65916;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65918,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65918,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__65900){
var self__ = this;
var G__65900__$1 = this;
return (new cljs.core.RecordIter((0),G__65900__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65904,other65905){
var self__ = this;
var this65904__$1 = this;
return (((!((other65905 == null)))) && ((((this65904__$1.constructor === other65905.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65904__$1.tag,other65905.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65904__$1.prefix,other65905.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65904__$1.sym,other65905.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65904__$1.children,other65905.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65904__$1.__extmap,other65905.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k65902){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k65902);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__65900){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__65957 = cljs.core.keyword_identical_QMARK_;
var expr__65958 = k__4511__auto__;
if(cljs.core.truth_((pred__65957.cljs$core$IFn$_invoke$arity$2 ? pred__65957.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__65958) : pred__65957.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__65958)))){
return (new rewrite_clj.node.quote.QuoteNode(G__65900,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65957.cljs$core$IFn$_invoke$arity$2 ? pred__65957.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__65958) : pred__65957.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__65958)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__65900,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65957.cljs$core$IFn$_invoke$arity$2 ? pred__65957.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__65958) : pred__65957.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__65958)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__65900,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65957.cljs$core$IFn$_invoke$arity$2 ? pred__65957.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__65958) : pred__65957.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__65958)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__65900,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__65900),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__65900){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__65900,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__65906){
var extmap__4542__auto__ = (function (){var G__65984 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65906,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__65906)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65984);
} else {
return G__65984;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__65906),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__65906),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__65906),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__65906),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var G__66070 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__66070;
continue;
}
break;
...
var G__66071 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__66071;
continue;
}
break;
...
var G__66074 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__66074;
continue;
}
break;
...
var G__66076 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__66076;
continue;
}
break;
