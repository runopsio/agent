...
webapp.components.codemirror_editor.editor = (function webapp$components$codemirror_editor$editor(p__30316){
var map__30317 = p__30316;
var map__30317__$1 = cljs.core.__destructure_map(map__30317);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30317__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
...
var lambda_view = (function (p1__30310_SHARP_){
return (new module$node_modules$$codemirror$basic_setup$dist$index_cjs.EditorView(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"state","state",-1988618099),editor_state,new cljs.core.Keyword(null,"parent","parent",-878878779),p1__30310_SHARP_], null))));
});
