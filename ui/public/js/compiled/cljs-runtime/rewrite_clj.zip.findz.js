...
var len__4864__auto___67001 = arguments.length;
var i__4865__auto___67002 = (0);
while(true){
if((i__4865__auto___67002 < len__4864__auto___67001)){
args__4870__auto__.push((arguments[i__4865__auto___67002]));

var G__67003 = (i__4865__auto___67002 + (1));
i__4865__auto___67002 = G__67003;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__66950){
var vec__66951 = p__66950;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66951,(0),null);
...
return (function (p1__66947_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__66947_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq66948){
var G__66949 = cljs.core.first(seq66948);
var seq66948__$1 = cljs.core.next(seq66948);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__66949,seq66948__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__66958,p__66959){
var map__66960 = p__66958;
var map__66960__$1 = cljs.core.__destructure_map(map__66960);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66960__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66960__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66960__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66960__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__66961 = p__66959;
var map__66961__$1 = cljs.core.__destructure_map(map__66961);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66961__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66961__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__66974_SHARP_){
var and__4251__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__66974_SHARP_) : p_QMARK_.call(null,p1__66974_SHARP_));
if(cljs.core.truth_(and__4251__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__66974_SHARP_)),pos);
} else {
return and__4251__auto__;
}
...
var G__66982 = zloc;
var G__66982__$1 = (((G__66982 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__66982) : f.call(null,G__66982)));
if((G__66982__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__66982__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__66983_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__66983_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__66988_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__66988_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__66995_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__66995_SHARP_),v);
}));
