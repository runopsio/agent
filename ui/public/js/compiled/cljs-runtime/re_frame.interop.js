...
return [(function (){var pred__63493 = cljs.core.instance_QMARK_;
var expr__63494 = reactive_val;
if(cljs.core.truth_((pred__63493.cljs$core$IFn$_invoke$arity$2 ? pred__63493.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__63494) : pred__63493.call(null,reagent.ratom.RAtom,expr__63494)))){
return "ra";
} else {
if(cljs.core.truth_((pred__63493.cljs$core$IFn$_invoke$arity$2 ? pred__63493.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__63494) : pred__63493.call(null,reagent.ratom.RCursor,expr__63494)))){
return "rc";
} else {
if(cljs.core.truth_((pred__63493.cljs$core$IFn$_invoke$arity$2 ? pred__63493.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__63494) : pred__63493.call(null,reagent.ratom.Reaction,expr__63494)))){
return "rx";
} else {
if(cljs.core.truth_((pred__63493.cljs$core$IFn$_invoke$arity$2 ? pred__63493.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__63494) : pred__63493.call(null,reagent.ratom.Track,expr__63494)))){
return "tr";
} else {
return "other";
}
