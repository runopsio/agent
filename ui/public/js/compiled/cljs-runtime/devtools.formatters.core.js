...
}catch (e59523){var _e__38955__auto__ = e59523;
return false;
...
}catch (e59526){var _e__38955__auto__ = e59526;
return false;
...
}catch (e59531){var _e__38955__auto__ = e59531;
return false;
...
}catch (e59534){var _e__38955__auto__ = e59534;
return false;
...
}catch (e59543){var _e__38955__auto__ = e59543;
return false;
}})())){
...
}catch (e59545){var _e__38955__auto__ = e59545;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__59551 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__59552 = (function (){var or__4253__auto__ = config;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__59552);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__59551);
}});
});
...
while (G__59564__i < G__59564__a.length) {G__59564__a[G__59564__i] = arguments[G__59564__i + 0]; ++G__59564__i;}
  args = new cljs.core.IndexedSeq(G__59564__a,0,null);
} 
