...
var G__63355 = o;
reagent.impl.template.goog$module$goog$object.set(G__63355,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__63382__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63382 = function (var_args){
var args = null;
...
while (G__63383__i < G__63383__a.length) {G__63383__a[G__63383__i] = arguments[G__63383__i + 0]; ++G__63383__i;}
  args = new cljs.core.IndexedSeq(G__63383__a,0,null);
} 
return G__63382__delegate.call(this,args);};
G__63382.cljs$lang$maxFixedArity = 0;
G__63382.cljs$lang$applyTo = (function (arglist__63384){
var args = cljs.core.seq(arglist__63384);
return G__63382__delegate(args);
});
G__63382.cljs$core$IFn$_invoke$arity$variadic = G__63382__delegate;
return G__63382;
})()
;
} else {
...
var G__63356 = o;
reagent.impl.template.goog$module$goog$object.set(G__63356,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__63386__i < G__63386__a.length) {G__63386__a[G__63386__i] = arguments[G__63386__i + 0]; ++G__63386__i;}
  args = new cljs.core.IndexedSeq(G__63386__a,0,null);
} 
...
var G__63357 = props;
var G__63357__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63357,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__63357);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63357__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__63358 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63358,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__63358;
}
})(),id_class);
...
var G__63359 = (cljs.core.count(argv) - first_child);
switch (G__63359) {
case (0):
...
var vec__63360 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63360,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63360,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63360,(2),null);
...
var temp__5757__auto___63389 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___63389 == null)){
} else {
var key_63390 = temp__5757__auto___63389;
(jsprops.key = key_63390);
}
...
var temp__5757__auto___63391 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___63391 == null)){
} else {
var key_63392 = temp__5757__auto___63391;
(jsprops.key = key_63392);
}
...
var temp__5757__auto___63393 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___63393 == null)){
} else {
var key_63394 = temp__5757__auto___63393;
(jsprops.key = key_63394);
}
...
var temp__5757__auto___63395 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___63395 == null)){
} else {
var key_63396 = temp__5757__auto___63395;
(jsprops.key = key_63396);
}
...
var temp__5757__auto___63397 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___63397 == null)){
} else {
var key_63398 = temp__5757__auto___63397;
(jsprops.key = key_63398);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63363_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__63363_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__63368 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63368,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63368,(1),null);
...
break;
default:
var G__63400 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__63401 = compiler;
v = G__63400;
compiler = G__63401;
continue;
...
var G__63374 = tag;
var G__63374__$1 = (((G__63374 instanceof cljs.core.Keyword))?G__63374.fqn:null);
switch (G__63374__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template63379 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template63379 = (function (opts,id,fn_to_element,parse_fn,meta63380){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta63380 = meta63380;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template63379.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_63381,meta63380__$1){
var self__ = this;
var _63381__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template63379(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta63380__$1));
}));

(reagent.impl.template.t_reagent$impl$template63379.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_63381){
var self__ = this;
var _63381__$1 = this;
return self__.meta63380;
}));

(reagent.impl.template.t_reagent$impl$template63379.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template63379.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template63379.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template63379.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template63379.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template63379.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta63380","meta63380",-1613948136,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template63379.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template63379.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template63379");

(reagent.impl.template.t_reagent$impl$template63379.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template63379");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template63379.
 */
reagent.impl.template.__GT_t_reagent$impl$template63379 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template63379(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta63380){
return (new reagent.impl.template.t_reagent$impl$template63379(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta63380));
});

}

return (new reagent.impl.template.t_reagent$impl$template63379(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
