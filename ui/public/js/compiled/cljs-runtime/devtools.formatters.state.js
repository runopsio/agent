...
var len__4864__auto___57025 = arguments.length;
var i__4865__auto___57026 = (0);
while(true){
if((i__4865__auto___57026 < len__4864__auto___57025)){
args__4870__auto__.push((arguments[i__4865__auto___57026]));

var G__57027 = (i__4865__auto___57026 + (1));
i__4865__auto___57026 = G__57027;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq56992){
var G__56993 = cljs.core.first(seq56992);
var seq56992__$1 = cljs.core.next(seq56992);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56993,seq56992__$1);
}));
...
return cljs.core.some((function (p1__57000_SHARP_){
return (p1__57000_SHARP_ === object);
}),history);
});
