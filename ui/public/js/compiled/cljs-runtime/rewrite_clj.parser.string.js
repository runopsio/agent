...
if((c === "\n")){
var G__66581 = escape_QMARK_;
var G__66582 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__66581;
lines = G__66582;
continue;
} else {
buf.append(c);

var G__66585 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__66586 = lines;
escape_QMARK_ = G__66585;
lines = G__66586;
continue;
...
var G__66576 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__66576) : rewrite_clj.node.string_node.call(null,G__66576));
});
...
var G__66577 = cljs.core.re_pattern(regex);
var G__66578 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__66577,G__66578) : rewrite_clj.node.token_node.call(null,G__66577,G__66578));
});
