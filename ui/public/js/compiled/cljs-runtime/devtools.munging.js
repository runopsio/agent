...
var o56881 = temp__5751__auto__;
var temp__5751__auto____$1 = (o56881["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o56882 = temp__5751__auto____$1;
return (o56882["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38899__auto__ = f;
return (o__38899__auto__["toString"]).call(o__38899__auto__);
} else {
return "";
}
}catch (e56889){var _ = e56889;
return "";
}});
...
try{var o__38899__auto___57094 = t;
(o__38899__auto___57094["cljs$lang$ctorPrWriter"]).call(o__38899__auto___57094,t,writer);
}catch (e56894){var __57095 = e56894;
}
...
var char_code = (function (){var o__38899__auto__ = (new String(char$));
return (o__38899__auto__["charCodeAt"]).call(o__38899__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38899__auto__ = String;
return (o__38899__auto__["fromCharCode"]).call(o__38899__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__56902 = num_code;
switch (G__56902) {
case (1):
return (185);
...
var o__38899__auto__ = String;
return (o__38899__auto__["fromCharCode"]).call(o__38899__auto__,superscript_code);
});
/**
...
}catch (e56913){var _e__38955__auto__ = e56913;
return false;
}})())){
...
var vec__56916 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56916,(0),null);
...
var len__4864__auto___57111 = arguments.length;
var i__4865__auto___57112 = (0);
while(true){
if((i__4865__auto___57112 < len__4864__auto___57111)){
args__4870__auto__.push((arguments[i__4865__auto___57112]));

var G__57113 = (i__4865__auto___57112 + (1));
i__4865__auto___57112 = G__57113;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__56928){
var vec__56929 = p__56928;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56929,(0),null);
...
var G__57114 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__57115 = cljs.core.butlast(remaining_tokens);
name_tokens = G__57114;
remaining_tokens = G__57115;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq56922){
var G__56923 = cljs.core.first(seq56922);
var seq56922__$1 = cljs.core.next(seq56922);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56923,seq56922__$1);
}));
...
var vec__56936 = cljs.core.split_with((function (p1__56935_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__56935_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56936,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56936,(1),null);
...
var vec__56946 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56946,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56946,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__57117 = cljs.core.rest(remaining_tokens);
var G__57118 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__57117;
name_tokens = G__57118;
continue;
} else {
...
var vec__56958 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56958,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56958,(1),null);
var vec__56961 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56961,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56961,(1),null);
var vec__56964 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56964,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56964,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56964,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56964,(3),null);
...
var vec__56970 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56970,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56970,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56970,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56970,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56970,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56970,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__56973 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56973,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56973,(1),null);
var vec__56976 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56976,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56976,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__56983 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__56983) : devtools.munging.parse_fn_info_deep.call(null,G__56983));
})()));
}
} else {
return fn_info;
...
var G__57147 = (arity + (1));
var G__57148 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__56988){
var vec__56989 = p__56988;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56989,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56989,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57001_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__57001_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57005_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__57005_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__57013){
var vec__57014 = p__57013;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57014,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq57008){
var G__57009 = cljs.core.first(seq57008);
var seq57008__$1 = cljs.core.next(seq57008);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57009,seq57008__$1);
}));
...
var map__57049 = options;
var map__57049__$1 = cljs.core.__destructure_map(map__57049);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57049__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57049__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57049__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57049__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__57050 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57050,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57050,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57050,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57050,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57050,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57050,(5),null);
...
var o__38899__auto__ = f;
return (o__38899__auto__["getBasis"]).call(o__38899__auto__);
});
/**
...
}catch (e57058){var _e__38955__auto__ = e57058;
...
var G__57178 = (obj[cljs.core.first(path)]);
var G__57179 = cljs.core.rest(path);
obj = G__57178;
path = G__57179;
continue;
} else {
...
var _STAR_ = (function (accum,p__57060){
var vec__57061 = p__57060;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57061,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57061,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__57067){
var vec__57068 = p__57067;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57068,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57068,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57068,(2),null);
...
var post_process = (function (p__57078){
var vec__57079 = p__57078;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57079,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57079,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57072_SHARP_){
return (obj[cljs.core.first(p1__57072_SHARP_)]);
}),sorted_matches);
