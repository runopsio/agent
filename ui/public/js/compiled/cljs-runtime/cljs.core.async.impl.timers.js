...
var i_69981 = (0);
while(true){
if((i_69981 < arr.length)){
(arr[i_69981] = null);

var G__69982 = (i_69981 + (1));
i_69981 = G__69982;
continue;
} else {
}
...
var i_70049 = (self__.level + (1));
while(true){
if((i_70049 <= (new_level + (1)))){
(update[i_70049] = self__.header);

var G__70061 = (i_70049 + (1));
i_70049 = G__70061;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_70062 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_70062[i]));
} else {
x__$2.forward.push((((i < links_70062.length))?(links_70062[i]):null));
}

if((i < links_70062.length)){
(links_70062[i] = x__$2);
} else {
links_70062.push(x__$2);
}
...
var i_70068 = (0);
while(true){
if((i_70068 <= self__.level)){
var links_70069 = (update[i_70068]).forward;
if((x__$1 === (((i_70068 < links_70069.length))?(links_70069[i_70068]):null))){
(links_70069[i_70068] = (x__$1.forward[i_70068]));

var G__70070 = (i_70068 + (1));
i_70068 = G__70070;
continue;
} else {
var G__70071 = (i_70068 + (1));
i_70068 = G__70071;
continue;
}
} else {
...
var G__70073 = nx;
var G__70074 = (level__$1 - (1));
x = G__70073;
level__$1 = G__70074;
continue;
} else {
var G__70075 = x;
var G__70076 = (level__$1 - (1));
x = G__70075;
level__$1 = G__70076;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__70078 = nx;
var G__70079 = (level__$1 - (1));
x = G__70078;
level__$1 = G__70079;
continue;
} else {
var G__70080 = x;
var G__70081 = (level__$1 - (1));
x = G__70080;
level__$1 = G__70081;
continue;
}
