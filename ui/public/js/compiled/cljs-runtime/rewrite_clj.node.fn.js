...
var syms = (function (){var iter__4652__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__66138(s__66139){
return (new cljs.core.LazySeq(null,(function (){
var s__66139__$1 = s__66139;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__66139__$1);
if(temp__5753__auto__){
var s__66139__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__66139__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__66139__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__66141 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__66140 = (0);
while(true){
if((i__66140 < size__4651__auto__)){
var i = cljs.core._nth(c__4650__auto__,i__66140);
...
cljs.core.chunk_append(b__66141,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__66260 = (i__66140 + (1));
i__66140 = G__66260;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__66141),rewrite_clj$node$fn$fn_walk_$_iter__66138(cljs.core.chunk_rest(s__66139__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__66141),null);
}
} else {
var i = cljs.core.first(s__66139__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__66138(cljs.core.rest(s__66139__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__66137_SHARP_){
var or__4253__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__66137_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k66145,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__66150 = k66145;
var G__66150__$1 = (((G__66150 instanceof cljs.core.Keyword))?G__66150.fqn:null);
switch (G__66150__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k66145,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__66151){
var vec__66152 = p__66151;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66152,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66152,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__66144){
var self__ = this;
var G__66144__$1 = this;
return (new cljs.core.RecordIter((0),G__66144__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this66146,other66147){
var self__ = this;
var this66146__$1 = this;
return (((!((other66147 == null)))) && ((((this66146__$1.constructor === other66147.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66146__$1.children,other66147.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66146__$1.__extmap,other66147.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k66145){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k66145);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__66144){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__66178 = cljs.core.keyword_identical_QMARK_;
var expr__66179 = k__4511__auto__;
if(cljs.core.truth_((pred__66178.cljs$core$IFn$_invoke$arity$2 ? pred__66178.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__66179) : pred__66178.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__66179)))){
return (new rewrite_clj.node.fn.FnNode(G__66144,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__66144),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__66144){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__66144,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__66149){
var extmap__4542__auto__ = (function (){var G__66235 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__66149,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__66149)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__66235);
} else {
return G__66235;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__66149),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
