...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__36624 = cljs.core.get_global_hierarchy;
return (fexpr__36624.cljs$core$IFn$_invoke$arity$0 ? fexpr__36624.cljs$core$IFn$_invoke$arity$0() : fexpr__36624.call(null));
})());
...
webapp.components.modal.markup.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"open","open",-1763596448),(function (_,modal_status){
var modal_size = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(modal_status),new cljs.core.Keyword(null,"large","large",-196820544)))?"w-2/3 max-w-full":"max-w-xl w-full");
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.fixed.z-20.inset-0.overflow-y-auto","div.fixed.z-20.inset-0.overflow-y-auto",1534656577),new cljs.core.PersistentArrayMap(null, 1, ["aria-modal",true], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.fixed.w-full.h-full.inset-0.bg-gray-100.bg-opacity-90.transition","div.fixed.w-full.h-full.inset-0.bg-gray-100.bg-opacity-90.transition",594918901),new cljs.core.PersistentArrayMap(null, 2, ["aria-hidden","true",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
