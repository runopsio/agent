...
var ___$1 = re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"open-modal","open-modal",947793572),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.tasks.views.new_task.task_details.main], null),new cljs.core.Keyword(null,"large","large",-196820544)], null));
return null;
});
...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__31641 = cljs.core.get_global_hierarchy;
return (fexpr__31641.cljs$core$IFn$_invoke$arity$0 ? fexpr__31641.cljs$core$IFn$_invoke$arity$0() : fexpr__31641.call(null));
})());
...
var _ = re_frame.core.dispatch(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-tasks","get-tasks",-1984554960)], null));
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-white.pb-regular.mb-x-large","div.bg-white.pb-regular.mb-x-large",1587395443),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"header.flex.mb-small.px-small","header.flex.mb-small.px-small",-780612945),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.font-bold","div.font-bold",2116623818),"History"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [webapp.tasks.views.new_task.tasks_list.refresh_tasks,new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tasks))], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"section","section",-300141526),(function (){var iter__4652__auto__ = (function webapp$tasks$views$new_task$tasks_list$main_$_iter__31642(s__31643){
return (new cljs.core.LazySeq(null,(function (){
var s__31643__$1 = s__31643;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__31643__$1);
if(temp__5753__auto__){
var s__31643__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31643__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__31643__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__31645 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__31644 = (0);
while(true){
if((i__31644 < size__4651__auto__)){
var task = cljs.core._nth(c__4650__auto__,i__31644);
cljs.core.chunk_append(b__31645,cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.border-b.hover:bg-gray-100.p-small.cursor-pointer","div.border-b.hover:bg-gray-100.p-small.cursor-pointer",1985790700),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__31644,task,c__4650__auto__,size__4651__auto__,b__31645,s__31643__$2,temp__5753__auto__,tasks,_){
return (function (){
return webapp.tasks.views.new_task.tasks_list.open_modal(task);
});})(i__31644,task,c__4650__auto__,size__4651__auto__,b__31645,s__31643__$2,temp__5753__auto__,tasks,_))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31645),webapp$tasks$views$new_task$tasks_list$main_$_iter__31642(cljs.core.chunk_rest(s__31643__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31645),null);
}
} else {
var task = cljs.core.first(s__31643__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.border-b.hover:bg-gray-100.p-small.cursor-pointer","div.border-b.hover:bg-gray-100.p-small.cursor-pointer",1985790700),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (task,s__31643__$2,temp__5753__auto__,tasks,_){
return (function (){
return webapp.tasks.views.new_task.tasks_list.open_modal(task);
});})(task,s__31643__$2,temp__5753__auto__,tasks,_))
], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"header.flex","header.flex",-821005013),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.text-xs.text-gray-500","div.text-xs.text-gray-500",1569373991),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(task)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.text-xs.text-gray-900.truncate.overflow-hidden.flex-grow.text-right.italic","div.text-xs.text-gray-900.truncate.overflow-hidden.flex-grow.text-right.italic",1059363183),new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(task)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xs text-gray-500"], null),webapp.formatters.time_ago(new cljs.core.Keyword(null,"created","created",-704993748).cljs$core$IFn$_invoke$arity$1(task))], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"section","section",-300141526),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-small"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xs text-gray-900 font-bold truncate overflow-hidden"], null),new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(task)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xs text-gray-500 font-light truncate overflow-hidden"], null),new cljs.core.Keyword(null,"script","script",-1304443801).cljs$core$IFn$_invoke$arity$1(task)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(task)], null)),webapp$tasks$views$new_task$tasks_list$main_$_iter__31642(cljs.core.rest(s__31643__$2)));
}
} else {
return null;
}
