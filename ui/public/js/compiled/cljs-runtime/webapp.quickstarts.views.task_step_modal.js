...
webapp.quickstarts.views.task_step_modal.main = (function webapp$quickstarts$views$task_step_modal$main(change_step,target_name){
var new_task = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("webapp.subs","new-task","webapp.subs/new-task",1755247024)], null)));
...
})(),(function (p1__32279_SHARP_){
return webapp.quickstarts.views.task_step_modal.submit_task_on_keydown(p1__32279_SHARP_);
}),(10),"script_area",(function (p1__32277_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-new-task-script","set-new-task-script",1957710486),p1__32277_SHARP_.target.value], null));
}),"font-mono"]);
