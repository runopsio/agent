...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k66166,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__66170 = k66166;
var G__66170__$1 = (((G__66170 instanceof cljs.core.Keyword))?G__66170.fqn:null);
switch (G__66170__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k66166,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__66172){
var vec__66173 = p__66172;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66173,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66173,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__66165){
var self__ = this;
var G__66165__$1 = this;
return (new cljs.core.RecordIter((0),G__66165__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this66167,other66168){
var self__ = this;
var this66167__$1 = this;
return (((!((other66168 == null)))) && ((((this66167__$1.constructor === other66168.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66167__$1.tag,other66168.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66167__$1.wrap_fn,other66168.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66167__$1.wrap_length,other66168.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66167__$1.seq_fn,other66168.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66167__$1.children,other66168.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66167__$1.__extmap,other66168.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__66214 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__66214) : self__.seq_fn.call(null,G__66214));
}));
...
var self__ = this;
var this$__$1 = this;
var G__66217 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__66217) : self__.wrap_fn.call(null,G__66217));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k66166){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k66166);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__66165){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__66231 = cljs.core.keyword_identical_QMARK_;
var expr__66232 = k__4511__auto__;
if(cljs.core.truth_((pred__66231.cljs$core$IFn$_invoke$arity$2 ? pred__66231.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__66232) : pred__66231.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__66232)))){
return (new rewrite_clj.node.seq.SeqNode(G__66165,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66231.cljs$core$IFn$_invoke$arity$2 ? pred__66231.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__66232) : pred__66231.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__66232)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__66165,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66231.cljs$core$IFn$_invoke$arity$2 ? pred__66231.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__66232) : pred__66231.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__66232)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__66165,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66231.cljs$core$IFn$_invoke$arity$2 ? pred__66231.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__66232) : pred__66231.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__66232)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__66165,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66231.cljs$core$IFn$_invoke$arity$2 ? pred__66231.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__66232) : pred__66231.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__66232)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__66165,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__66165),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__66165){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__66165,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__66169){
var extmap__4542__auto__ = (function (){var G__66246 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__66169,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__66169)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__66246);
} else {
return G__66246;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__66169),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__66169),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__66169),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__66169),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__66169),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__66255_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__66255_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__66264_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__66264_SHARP_);
}),children);
});
